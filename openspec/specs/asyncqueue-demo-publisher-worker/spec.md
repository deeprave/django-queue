# AsyncQueue Demo Publisher and Worker

## Purpose

Define how the demo project seeds and processes realistic AsyncQueue tasks.
...
task SHALL contain additional metadata and one Faker-generated random message.
...
- **WHEN** the publisher command and `runqueues` worker run under ordinary
  Redis availability
- **THEN** it produces and processes demo tasks with deliberately failed
  entries, without retries, cancellations, or broker failures
