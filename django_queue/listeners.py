"""Process-local registration for transient event listeners."""
...
def queue_listener(
    ...
    """Register a local listener for one configured :class:`EventQueue`."""
    ...
    def register(callback: EventListener) -> EventListener:
        ...
        if not isinstance(queues[queue_name], EventQueue):
            raise TypeError("queue listeners require an EventQueue")
